                ...
                <ul className="mt-6 grid gap-4 sm:grid-cols-2">
                  {items.map((d) => (
                    <li key={d.title}>
                      ...
                      >
                        <article className="flex h-full items-start gap-4 rounded-md border border-border bg-card p-5 transition-shadow hover:shadow-lg">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {d.status === "available" ? (
                              <p className="mt-3 inline-flex items-center gap-1.5 rounded-sm bg-green-100 px-2 py-1 text-xs font-semibold uppercase tracking-wide text-green-700">
